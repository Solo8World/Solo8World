...
真正使用时，没有必要复制粘贴给chatGPT,这里罗列的提示语只是起到一个抛砖引玉的作用，
帮助读者打开思路，找到自己真正需要的场景，仅此而已。
...
# 再次重申
  真正会使用的人真的不必按上文内容照本宣科，以上内容只是希望你能收获两点：
*  一是打开思路，去发掘更多的场景以及找到适用自己的场景，真正的发挥它对你的生产力。比如最近本人
  要考PMP,经常让他出些题目我来回答，然后他来判断对错并解析题目，学习效率倍增，甚至它偶尔会给我很多鼓励。
*  第二是，希望读者能从上文的提示词中，明白一个好的提问
  所要具备的要素，比如问题背景，具体要求等等。而不是一个泛泛的问题，除非你想得到一个泛泛的回答。
  这些，要自己悟的。愿所有人都能从此得益。
